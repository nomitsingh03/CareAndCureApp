...
public class AdminController {
    ...
    public ResponseEntity<AdminInfo> loginAdmin(@RequestParam String username, @RequestParam String password) throws UserNotFoundException {
        AdminInfo adminInfo = adminService.loginAdmin(username, password);
